...
Welcome to `mlflow-flavors` contributor's guide.
...
If you experience bugs or general issues with `mlflow-flavors`, please have a look
...
You can help improve `mlflow-flavors` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`mlflow-flavors` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `mlflow-flavors`'s files. While this mechanism can
...
```
conda create -n mlflow-flavors python=3 six virtualenv pytest pytest-cov
conda activate mlflow-flavors
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/mlflow-flavors.git
   cd mlflow-flavors
   ```
...
5. Install [pre-commit]:
   ...
   `mlflow-flavors` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/mlflow-flavors
[issue tracker]: https://github.com/<USERNAME>/mlflow-flavors/issues
